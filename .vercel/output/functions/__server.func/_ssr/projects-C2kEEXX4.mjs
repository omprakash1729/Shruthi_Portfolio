  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-6 lg:px-10 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card overflow-hidden grid lg:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 md:p-10 flex flex-col", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto pt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "inline-flex items-center gap-2 text-primary font-semibold text-sm hover:gap-3 transition-all", children: [
          "View Case Study ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-6 lg:px-10 py-8 grid md:grid-cols-2 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "surface-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[16/10]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: projectBioner, alt: "Hybrid biomedical NER", loading: "lazy", className: "size-full object-cover" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { children: "Email Marketing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { children: "WhatsApp API" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-4 font-display font-semibold text-xl", children: "Omnichannel Lead Nurture Sequence" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Integrated Mailchimp and WhatsApp API automation workflow that significantly improved lead retention and boosted conversion rates by 25%." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 h-0.5 w-12 rounded-full", style: {
            background: "var(--gradient-primary)"
          } })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "surface-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[16/10]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: projectCrop, alt: "Climate-based crop recommendation", loading: "lazy", className: "size-full object-cover" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { children: "Data Science" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { children: "Python" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-4 font-display font-semibold text-xl", children: "Marketing Data Science Foundation" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Building on an academic background in ML: Developed predictive systems like a Climate Crop Recommender and NLP summarizers." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 h-0.5 w-12 rounded-full", style: {
            background: "var(--gradient-primary)"
          } })
        ] })
