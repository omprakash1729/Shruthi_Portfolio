    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="btn-ghost inline-flex px-5 py-2.5 text-sm font-medium">
            Go home
          </a>
        </div>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Shruthi Ram R S — Digital Marketing & Data Science" },
      {
        name: "description",
        content:
          "Portfolio of Shruthi Ram R S — Digital Marketing strategist and Data Science practitioner building data-driven growth ecosystems.",
      },
